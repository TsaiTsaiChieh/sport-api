...
async function settleGodRank(args) {
    ...
    diamond.forEach(function(items) { // 這裡有順序性
      ...
      generateGSC(period, period_date, uid, currentSeason, currentMonth, items);
    });
}
...
/*大神更新*/
async function updateGod(god_type, ele){
