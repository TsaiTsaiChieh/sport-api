        ...
        SELECT * FROM(
         ...
         SELECT cs.ingot, 0 as coin, 0 as dividend, "售牌收入" as title, "sell" as en_title, name_ch, display_name, NULL as article_title, cs.scheduled
          ...
          WHERE cs.buy_id = cb.buy_id
            ...
            AND cs.uid = u.uid
          UNION
         SELECT 0 as ingot, 0 as coin, expire_points as dividend, "消費紅利回饋" as title, "dividend_refund" as en_title, NULL as name_ch, NULL as display_name, NULL as article_title, scheduled
           FROM cashflow_dividends
          WHERE status=1
          UNION
         SELECT 0 as ingot, 0 as coin, expire_points as dividend, "紅利過期紀錄" as title, "dividend_expire" as en_title, NULL as name_ch, NULL as display_name, NULL as article_title, scheduled
           FROM cashflow_dividends
          WHERE status=0
         ) transfer
