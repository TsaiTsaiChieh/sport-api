        ...
        if (exchange.type === 'buy_coin') {
          ...
          if (exchange.output === 'coin') {
            ...
            try {
              ...
              const cashflow_ingot_transfer_cash = await db.sequelize.models.cashflow_ingot_transfer.create({ uid: uid, status: status, ingot: (-1) * exchange.ingot, ingot_real: (-1) * exchange.ingot_real, coin: exchange.coin, coin_real: exchange.coin_real, money: exchange.money, money_real: exchange.money_real, dividend: exchange.dividend, dividend_real: exchange.dividend_real, fee: exchange.fee, fee_real: exchange.fee_real, scheduled: scheduled });
