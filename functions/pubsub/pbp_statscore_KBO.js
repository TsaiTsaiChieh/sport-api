  ...
  if (realtimeData) {
    if (realtimeData.Summary) {
      if (realtimeData.Summary.Livetext) {
        eventNow = realtimeData.Summary.Livetext.length;
      }
    ...
    try {
      ...
      if (
        ...
        try {
          ...
          await modules.database
            .ref(`baseball/KBO/${betsID}/Summary/Now_pitcher`)
            .set({
              order: 10
            });
          // 教練
            ...
            try {
              if (
                ...
                await modules.database
                  ...
                  .set(nowHitterHome);
                await modules.database
                  .ref(`baseball/KBO/${betsID}/Summary/Next1_hiiter_home`)
                  .set(nowHitterHome + 1 === 9 ? 9 : (nowHitterHome + 1) % 9);
                await modules.database
                  .ref(`baseball/KBO/${betsID}/Summary/Next2_hiiter_home`)
                ...
                await modules.database
                  ...
                  .set(nowHitterAway);
                await modules.database
                  .ref(`baseball/KBO/${betsID}/Summary/Next1_hiiter_away`)
                  .set(nowHitterAway + 1 === 9 ? 9 : (nowHitterAway + 1) % 9);
                await modules.database
                  .ref(`baseball/KBO/${betsID}/Summary/Next2_hiiter_away`)
          ...
          if (
            ...
            try {
              ...
              if (
                ...
                nowPitcherHome =
                  realtimeData.Summary.info.home.Now_lineup.length;
                await modules.database
                ...
                await modules.database
                  .ref(
                    `baseball/KBO/${betsID}/Summary/info/home/lineup${nowPitcherHome}`
                  )
                  .set(homeLineup[homeLineup.length - 1]);
              } else {
                nowPitcherAway =
                  realtimeData.Summary.info.away.Now_lineup.length;
                await modules.database
                ...
                await modules.database
                  .ref(
                    `baseball/KBO/${betsID}/Summary/info/away/lineup${nowPitcherAway}`
                  )
