...
const errorCodeLists = {
  ...
  1325: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['新增 users__win_lists_history 失敗 ', 'Create users__win_lists_history 產生 ER_LOCK_DEADLOCK'] },
  1326: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['新增 users__win_lists_history 失敗 ', 'Create users__win_lists_history 產生 ER_DUP_ENTRY'] },
  ...
  1330: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['更新 users__win_lists_history 失敗 ', 'Update users__win_lists_history 不明原因錯誤'] },
  1331: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['新增 users__win_lists 失敗 ', 'Create users__win_lists 產生 ER_LOCK_DEADLOCK'] },
  1332: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['新增 users__win_lists 失敗 ', 'Create users__win_lists 產生 ER_DUP_ENTRY'] },
  1333: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['新增 users__win_lists 失敗 ', 'Create users__win_lists 不明原因錯誤'] },
  1334: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['更新 users__win_lists 失敗 ', 'Update users__win_lists失敗 產生 ER_LOCK_DEADLOCK'] },
  1335: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['更新 users__win_lists 失敗 ', 'Update users__win_lists失敗 產生 ER_DUP_ENTRY'] },
  1336: { msg: ['更新 使用者勝注勝率資料 失敗'], backend: ['更新 users__win_lists 失敗 ', 'Update users__win_lists失敗 不明原因錯誤'] },
  ...
  1341: { msg: ['更新 賽事 失敗'], backend: ['更新 matches 失敗 ', 'Update matches 產生 ER_LOCK_DEADLOCK'] },
  1342: { msg: ['更新 賽事 失敗'], backend: ['更新 matches 失敗 ', 'Update matches 產生 ER_DUP_ENTRY'] },
  1343: { msg: ['更新 使用者預測單 失敗'], backend: ['更新 user__predictions 失敗 ', 'Update user__predictions 產生 ER_LOCK_DEADLOCK'] },
  1344: { msg: ['更新 使用者預測單 失敗'], backend: ['更新 user__predictions 失敗 ', 'Update user__predictions 產生 ER_DUP_ENTRY'] }
};
