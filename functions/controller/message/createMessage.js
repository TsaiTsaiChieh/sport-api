 ...
 * @apiParam {String} message.message content, plain text or URL
 * @apiParam {String} message.type message type, the value enum are: `text`, `image/jpeg`, `image/png`, `video/mp4`
