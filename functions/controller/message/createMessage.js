 ...
 * @apiParam {String} message.type message type, the value enum are: `text`, `image/jpeg`, `image/png`, `video/mp4`. If the message content is not plain text, message must be a URL
