...
async function livescoreAll(req, res) {
  const schema = {
  ...
  try {
    ...
    console.error('Error in controller/livescore/livescoreAll by DY', err);
    res
      .status(err.code)
      .json(
        err.isPublic
...
/**
 * @api {GET} /livescore/all Get Livescore of all event by DY
 * @apiVersion 1.0.0
