  ...
  return new Promise(async function(resolve, reject) {
    try {
      ...
      const result = await db.sequelize.query(
        `SELECT user.id, user.uid AS uid, user.status, user.avatar, user.birthday, user.birthday_tw, user.display_name, user.email, user.name, user.country_code, user.phone, user.point, user.signature, user.fan_count, user.default_title, user.default_god_league_rank, user.accuse_credit, user.block_count, user.unread_count, user.dividend, user.coin, user.ingot, user.invoice_carrier, user.deposit_lottery, user.referrer, user.deny, user.rank1_count, user.rank2_count, user.rank3_count, user.rank4_count, user.createdAt, user.updatedAt, 
